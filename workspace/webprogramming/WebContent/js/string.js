...
function proc1(){
	...
	document.getElementById("result").innerHTML = ch + ", 유니코드 : " + chCode;
		
}

function proc2(){
	var index = str.indexOf("o", 4);	//4번째 인덱스부터 검색
	...
	document.getElementById("result").innerHTML = index + "," + lastIndex;
...
function proc6(){
	...
	document.getElementById("result").innerHTML = str.substring(0, 1);
}
